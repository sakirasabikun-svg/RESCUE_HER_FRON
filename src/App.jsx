...
//       styleNode.id = 'professional-cursor-styles';
//       styleNode.innerHTML = `
//         /* 🖥️ শুধুমাত্র ডেসকটপ (মাউসওয়ালা ডিভাইস) এর জন্য কাস্টম কার্সার অ্যাক্টিভ হবে */
...
//         /* 📱 মোবাইল বা টাচ স্ক্রিন ডিভাইসের জন্য কাস্টম কার্সার হাইড করে নরমাল টাচ আনা হলো */
...
////dark mode thik korlam settings page er 
// src/App.jsx
import React, { useState, useEffect } from 'react';
import './App.css';
import LandingPage from './pages/LandingPage'; 
...
function App() {
  ...
  // ডার্ক মোড গ্লোবাল ফিক্স: লোকাল স্টোরেজ ও DOM এলিমেন্ট ক্লাস টগল
  useEffect(() => {
    localStorage.setItem('themeMode', isDarkMode ? 'dark' : 'light');
  ...
  useEffect(() => {
    ...
    if (!existingStyle) {
      ...
      styleNode.id = 'professional-cursor-styles';
      styleNode.innerHTML = `
        /* 🖥️ শুধুমাত্র ডেসকটপ (মাউসওয়ালা ডিভাইস) এর জন্য কাস্টম কার্সার অ্যাক্টিভ হবে */
        @media (pointer: fine) and (min-width: 769px) {
          html, body, a, button, [role="button"] {
            cursor: none !important;
          }
  ...
  const renderPage = () => {
    ...
    switch (activePage) {
      ...
      // এখানে ইমপোর্ট করা SettingsPage-এ ডাইনামিক props পাস করা হলো
      case 'Settings': return <SettingsPage theme={currentTheme} isDarkMode={isDarkMode} />;
  ...
  return (
    <div className={`app-container ${isSidebarOpen ? 'sidebar-open' : ''}`} style={{ backgroundColor: themeStyles.bg, minHeight: '100vh', transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)', overflowX: 'hidden' }}>
      ...
      <style>{`
        /* 🚀 ১. সাইডবার স্ক্রল ফিক্স (হামবার্গার মেনুর জন্য) */
        .sidebar {
          overflow-y: auto !important; /* মেনু বড় হলে নিজে থেকেই স্ক্রলবার আনা হবে */
          max-height: 100vh !important; /* স্ক্রিনের বাইরে যেতে দেবে না */
          -webkit-overflow-scrolling: touch; /* মোবাইলে স্মুথ স্ক্রলিং */
        }
